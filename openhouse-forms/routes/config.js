...
module.exports=function(pool){
  const OPT={
    ...
    banks:["Aditya Birla Housing Finance Ltd.","Au Small Finance Bank Ltd.","Axis Bank Ltd.","Bandhan Bank Ltd.","Bank of Baroda","Bank of India","Bank of Maharashtra","Bajaj Housing Finance","Canara Bank","Central Bank of India","City Union Bank Ltd.","CSB Bank Limited","DCB Bank Ltd.","Dhanlaxmi Bank Ltd.","Federal Bank Ltd.","Godrej Housing Finance","HDFC Bank Ltd","HSBC India","ICICI Bank Ltd.","IDBI Bank Limited","IDFC FIRST Bank Limited","IIFL Home loan Ltd.","Indian Bank","Indian Overseas Bank","IndusInd Bank Ltd","Jammu & Kashmir Bank Ltd.","Karnataka Bank Ltd.","Karur Vysya Bank Ltd.","Kotak Mahindra Bank Ltd","L&T Finance Bank Limited" ,"LIC Housing Finance Limited","Nainital bank Ltd.","Punjab & Sind Bank","Punjab National Bank","PNB Housing Finance limited","RBL Bank Ltd.","Save Housing Finance Limited","South Indian Bank Ltd.","Standard Charted India","State Bank of India","Tamilnad Mercantile Bank Ltd.","UCO Bank","Union Bank of India","Utkarsh Small Finance Bank Limited","YES Bank Ltd."],
    yesNo:["Yes","No"],
