...
const ADMIN_EDITABLE=new Set(['city','locality','society_name','unit_no','tower_no','floor','area_sqft','configuration',
      ...
      'deal_value','total_brokerage_amount','brokerage_ama_signed','brokerage_ama_signed_amount','brokerage_registry','brokerage_registry_amount','additional_brokerage','to_be_released_now','incentive_visit','incentive_owner_meeting','total_cp_amount',
